...
// // JavaScript code within your Gradio app
// const gr = gr.GrApp(); // Your Gradio app initialization code

// // Event listener for user input
// gr.on.input(() => {
//     const userInput = gr.inputs.textbox.getValue(); // Get user input from Gradio app
    
//     // Send user input to the PHP script
//     fetch("search_history.php", {
//         method: "POST",
...
//     .then(data => {
//         // Update Gradio app output with the search history
//         gr.outputs.textbox.setValue(data);
//     });
// });

// gr.launch(); // Launch your Gradio app
